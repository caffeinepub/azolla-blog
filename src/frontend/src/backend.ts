...
export class Backend implements backendInterface {
    ...
    async createPost(arg0: NewPost): Promise<void> {
        if (this.processError) {
            try {
    ...
    async listPublishedPosts(): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.listPublishedPosts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async togglePublished(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updatePost(arg0: bigint, arg1: NewPost): Promise<void> {
        if (this.processError) {
            try {
